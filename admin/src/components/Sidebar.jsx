  ...
  return (
    <div className='w-[18%] min-h-screen border-r-2'>
        ...
        <NavLink className='flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-1' to="/home">
            ...
            <NavLink className='flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-1' to="/index">
                <img className='w-5 h-5' src={assets.order_icon} alt="" />
            ...
            <NavLink className='flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-1' to="/actions">
                <img className='w-5 h-5' src={assets.order_icon} alt="" />
