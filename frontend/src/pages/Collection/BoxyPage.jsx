          ...
          <div>
            ...
            {accordion.sub && (
              <div className='pl-2 grid grid-cols-1 sm:grid-cols-2 gap-1'>
                {[
                 'Áo Thun & Polo', 'Áo thun Boxy', 'Áo thun Oversize', 
...
<div className="w-full overflow-x-auto scrollbar-hide py-4 mb-6">
  <div className="flex gap-4 min-w-max px-2 sm:px-4">
    {[
      ...
      { label: 'ÁO THUN', img: assets.aothun },
      { label: 'ÁO THUN BOXY', img: assets.aothunboxy },
      { label: 'ÁO THUN OVERSIZE', img: assets.aothunover },
      ...
      >
        ...
        <div className='flex justify-between items-center mb-4'>
          <Title text1={'BOXY T-SHIRT'} text2={'COLLECTION'} />
          <select
