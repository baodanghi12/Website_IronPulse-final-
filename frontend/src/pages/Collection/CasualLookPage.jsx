          ...
          <div>
            ...
            {accordion.sub && (
              <div className='pl-2 grid grid-cols-1 sm:grid-cols-2 gap-1'>
                {[
                 'Áo Thun & Polo', 'Áo Khoác', 'Áo Sơ Mi', 'Cơ Bản',
      ...
      <div className='flex-1'>
        <div className='w-full mb-4'>
          <img
            ...
            src={assets.casuallookimg}
            alt='Casual Look Banner'
          />
        </div>
...
<div className="w-full overflow-x-auto scrollbar-hide py-4 mb-6">
  <div className="flex gap-4 min-w-max px-2 sm:px-4">
    {[
      ...
      { label: 'ÁO', img: assets.shirt },
      { label: 'QUẦN', img: assets.pants },
      ].map((item, index) => (
      <div
        key={index}
      ...
      >
        ...
        <div className='flex justify-between items-center mb-4'>
          <Title text1={'CASUAL LOOK'} text2={'COLLECTION'} />
          <select
