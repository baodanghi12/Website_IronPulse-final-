...
const ChildrenCategoryPageQuan = () => {
    ...
    <div className='pt-10 border-t'>
      ...
      <div className="w-full overflow-x-auto scrollbar-hide py-4 mb-6">
        <div className="flex gap-4 min-w-max px-2 sm:px-4">
          {[
            { label: 'QUẦN', img: assets.quankid, link: '/children/pants/QUẦN' },
            { label: 'QUẦN SHORT', img: assets.quanshortkid, link: '/children/pants/QUẦN SHORT' },
            { label: 'QUẦN DÀI', img: assets.quandaikid, link: '/children/pants/QUẦN DÀI' },
            { label: 'QUẦN JEAN', img: assets.quanjeankid, link: '/children/pants/QUẦN JEAN' },
          ].map((item, index) => (
...
export default ChildrenCategoryPageQuan;