  ...
  return (
    <div className='pt-10 border-t'>
      ...
      <div className='w-full mb-4'>
        <img src={assets.kidimg} className='w-full h-60 object-cover rounded-xl' alt="Final Sale Banner" />
      </div>
      ...
      <div className="w-full overflow-x-auto scrollbar-hide py-4 mb-6">
        <div className="flex gap-4 min-w-max px-2 sm:px-4">
          {[
            { label: 'TẤT CẢ ÁO', img: assets.aothunkid, link: '/children/final-sale/ÁO' },
            { label: 'TẤT CẢ QUẦN', img: assets.quandaikid, link: '/children/final-sale/QUẦN' },
          ].map((item, index) => (
...
export default ChildrenFinalSale;