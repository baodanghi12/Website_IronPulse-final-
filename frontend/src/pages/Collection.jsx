...
const Collection = () => {
  const { products, search, showSearch, flashSaleItems } = useContext(ShopContext);
  ...
  // Map flash sale for quick lookup
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='flex-1'>
        <div className='flex justify-between text-base sm:text-2x1 mb-4'>
          ...
          <select onChange={(e) => setSortType(e.target.value)} className='border-2 border-gray-300 text-sn px-2'>
