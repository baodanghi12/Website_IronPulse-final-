          ...
          <div>
            ...
            {accordion.cat && (
              <div className='pl-2 space-y-1'>
                {['Áo', 'Quần', 'Giày Dép', 'Phụ Kiện'].map((cat) => (
...
<div className="w-full overflow-x-auto scrollbar-hide py-4 mb-6">
  ...
  {[
  { label: 'SALE', img: assets.sale, link: '/men/final-sale/ao' },
  { label: 'ÁO', img: assets.shirt, link: '/men/category/ao' },
  { label: 'QUẦN', img: assets.pants, link: '/men/quan/QUAN' },
