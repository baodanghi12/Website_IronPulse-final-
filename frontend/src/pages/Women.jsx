...
const Women = () => {
  ...
  return (
          ...
          <div>
            ...
            {accordion.sub && (
              <div className='pl-2 grid grid-cols-1 sm:grid-cols-2 gap-1'>
                {[
                  'Áo Croptop', 'Áo Thun', 'Áo Khoác', 'Áo Sơ mi', 'Đầm Công Sở', 'Váy Ngắn',
                  'váy Dài', 'Đầm Dự Tiệc'
                ].map((sub) => (
    ...
    {[
      { label: 'SALE', img: assets.salenu, link: '/women/final-sale/tất cả' },
      { label: 'ÁO', img: assets.shirt1, link: '/women/category/ao' },
      { label: 'QUẦN', img: assets.pants1, link: '/women/quan/QUAN' },
      { label: 'VÁY / ĐẦM', img: assets.dress1, link: '/women/vaydam/VAY' },
